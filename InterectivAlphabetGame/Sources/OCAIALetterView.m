...
-(instancetype)initWithLetter:(NSString *)letter lenght:(float)wordLenght{
    UIImage *backgroundImageLetter = [UIImage imageNamed:@"letterImg"];
    ...
    if (self) {
        ...
        character.font = [UIFont fontWithName:@"Verdana-Bold" size:78.0];
